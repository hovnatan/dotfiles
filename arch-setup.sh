...
yay -S skype git-cola dropbox wd719x-firmware aic94xx-firmware zoom i3ipc-python libinput-gestures clipster xcwd-git foxitreader i3lock-color gruvbox-icon-theme python-torchvision bear-git
