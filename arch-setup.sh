...
sudo pacman -Sy networkmanager os-prober openssh pepper-flash python-numpy ipython opencv ethtool lsb-release smartmontools x86_energy_perf_policy powertop tlp htop intel-gpu-tools cmake libva-intel-driver libva-utils intel-media-driver terminus-font ttf-ubuntu-font-family ttf-hack ttf-dejavu xorg fortune-mod workrave base-devel feh mpv xclip neovim python-neovim fzf tmux youtube-dl fish intel-ucode grub python-matplotlib glew vtk ccache boost eigen3 xf86-video-intel rofi dunst python-matplotlib zathura zathura-djvu zathura-ps zathura-pdf-mupdf redshift chromium i3-wm i3status perl-anyevent-i3 qt5-styleplugins python-gobject aws-cli unzip xautolock imagemagick scrot pulseaudio-alsa pulseaudio-bluetooth pulsemixer pulsemixer fuseiso ttf-liberation libreoffice-fresh inkscape gimp hunspell-en_US hplip avahi cups lm_sensors uget transmission-cli transmission-gtk wget python-scikit-learn python-scipy ack pavucontrol sshfs bluez bluez-utils acpi alsa-utils sysstat i3blocks texlive-core texlive-langextra pandoc xorg-xinit otf-font-awesome pdfgrep xbindkeys gdb cppcheck valgrind perf python-pip llvm ripgrep cython python-pytorch aria2 python-pandas tk libjpeg-turbo ctags time autojump python-language-server yarn autopep8 python-ipdb ttf-freefont ttf-arphic-uming ttf-baekmuk noto-fonts-emoji ranger w3m atool elinks odt2txt mediainfo highlight ffmpegthumbnailer atool noto-fonts-emoji yapf vte3
