...
conda update --all
import_miniconda
conda install pytorch torchvision opencv pillow yapf pylint jedi ipython rope boost tbb tbb-devel cmake conda-build Cython ipdb pudb sortedcontainers neovim matplotlib h5py scipy tensorboardx future sympy
