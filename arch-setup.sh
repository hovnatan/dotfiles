...
conda update --all
import_miniconda
conda install pytorch torchvision opencv pillow yapf pylint jedi ipython rope boost tbb tbb-devel cmake gxx_linux-64 conda-build Cython ipdb sortedcontainers
