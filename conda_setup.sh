...
import_miniconda
conda update --all
conda install pytorch torchvision opencv pillow boost matplotlib scipy conda-build Cython sympy pandas shapely scikit-image
...
pip install --no-deps git+https://github.com/aleju/imgaug.git
