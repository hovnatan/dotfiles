...
# import_miniconda
conda update -y --all
conda install -y pytorch torchvision opencv pillow boost matplotlib scipy conda-build Cython sympy pandas shapely scikit-image imgaug pycairo cvxpy cvxopt scikit-learn
conda install -y yapf pylint jedi ipython rope ipdb pudb sortedcontainers matplotlib h5py future prettytable easydict pynvim jupyter colorama pyyaml numba cachetools packaging pytest pytest-xdist pytest-cov coverage twine sphinx boto3
...
# pypng for indexed png, gitpython python wrapper for git
pip install pypng gitpython tensorboard sphinx-rtd-theme
