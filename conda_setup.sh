...
conda install -y pytorch torchvision cpuonly scikit-image kornia
...
pip install pypng gitpython tensorboard sphinx-rtd-theme pylint-json2html pylint-pytest pytest-timeout pyenchant pretty_errors scalene opencv-contrib-python reedsolo albumentations segmentation-models-pytorch imagecorruptions imgaug imutils
